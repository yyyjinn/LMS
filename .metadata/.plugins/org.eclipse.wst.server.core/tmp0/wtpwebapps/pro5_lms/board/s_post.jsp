	...
	<nav id = "navbar">
	    <div class = "nav_container">
	        <div class = "nav_logo_container">
	            <a href = "s_main.html"><img src="../images/logo.png" alt="ITUNIVERSITY"></a>
	        </div>
	        ...
	        <div class = "nav_ul_container information">
	            <ul>
	                ...
	                <li><a href="s_info.html">기본 정보 조회</a></li>
	            </ul>
	        </div>
	        ...
	        <div class = "nav_ul_container enrolment">
	            <ul>
	                ...
	                <li><a href="s_subject.html">수강 신청</a></li>
	                <li><a href="s_schedule.html">시간표 조회</a></li>
	            </ul>
	        </div>
	        ...
	        <div class = "nav_ul_container test">
	            <ul>
	                ...
	                <li><a href="s_exam.html">시험 응시</a></li>
	            </ul>
	        </div>
	        ...
	        <div class = "nav_ul_container gradecheck">
	            <ul>
	                ...
	                <li><a href="s_inquiry.html">성적 조회</a></li>
	            </ul>
	        </div>
	    </div>
	</nav>
