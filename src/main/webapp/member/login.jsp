        ...
        <div class="container">
            ...
            <div class="right-box">
               <div class="service">
                    ...
                    <div class="login">
                        <form action="http://localhost:8080/pro5_lms/member/login_process.do" class="form" name = "login_form" method="post">
                            <div class="input">                           
                    ...
                    <button class="signin"><a href="http://localhost:8080/pro5_lms/member/join.do">회원가입</a></button>         
                </div>    
                <div class="text">
